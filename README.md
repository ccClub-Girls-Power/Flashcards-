...
2. 可直接搜尋Line ID: @170mpjik 或是掃描QR code加入卡片盒機器人好友。Add official ID `@170mpjik` or scan the QRcode below to add "Flashcards Linebot" to your friend list.
3. 即可開始體驗卡片盒機器人啦！You are ready for the "Flashcards Linebot".
